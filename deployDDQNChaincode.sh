...
VERSION="1"
# CC_SRC_PATH="./artifacts/src/github.com/fabcar/chaincode-javascript/"
CC_SRC_PATH="./artifacts/chaincode/DDQN/"
...
chaincodeQuery() {
    setGlobalsForPeer0Org2
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "getAllDDQN","Args":[""]}'
}
