createcertificatesForOrg1() {
  ...
  fabric-ca-client enroll -u https://adminorg1:adminorg1pw@localhost:7054 --caname ca.org1.example.com --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
...
createCertificatesForOrg2() {
  ...
  fabric-ca-client enroll -u https://adminorg2:adminorg2pw@localhost:8054 --caname ca.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
